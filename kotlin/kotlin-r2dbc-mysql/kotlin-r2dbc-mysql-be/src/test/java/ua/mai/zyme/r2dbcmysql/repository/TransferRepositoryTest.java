...
class TransferRepositoryTest {
    ...
    public void save() {
        ...
        Transfer transferIn =
                new Transfer(null, memberFrom.getMemberId(), memberTo.getMemberId(), 100L, tu.now());
    ...
    public void saveAll() {
        ...
        List<Transfer> listIn = new ArrayList<>(List.of(
                new Transfer(null, memberFrom.getMemberId(), memberTo.getMemberId(), 200L, tu.now()),
                new Transfer(null, memberFrom2.getMemberId(), memberTo.getMemberId(), 50L, tu.now())
        ));
        List<Transfer> listResult = new ArrayList<>(1);
