...
(function () {
        ...
        htmlCss: function (a) {
            ...
            if (this.added) {
                var a =
                    ...
                    e = this.x || 0, f = this.y || 0, g = this.textAlign || "left", h = {
                        left: 0,
                        center: 0.5,
                        right: 1
    ...
    Ta.prototype = {
        addLabel: function () {
            ...
            var b = this.axis, c = a.x, d = b.chart.chartWidth, e = b.chart.spacing, f = p(b.labelLeft, C(b.pos, e[3])),
                e = p(b.labelRight, u(b.pos + b.len, d - e[1])), g = this.label, h = this.rotation, i = {
                    left: 0,
                    center: 0.5,
                    right: 1
    ...
    va.prototype = {
        ...
        defaultLabelFormatter: function () {
            // dose not show K,M.. in legend in value equals 1000 (1K)
            ...
            if (h) g = Ja(h, this);
            else if (c) g = b; else if (d) g = Oa(d, b);
            else if (f && a >= 1E3) for (; f-- && g === y;) c = Math.pow(1E3, f + 1), a >= c && b * 10 % c === 0 && e[f] !== null && (g = b );
            g === y && (g = O(b) >= 1E4 ? A.numberFormat(b, -1) : A.numberFormat(b, -1, y, ""));
            return g
        },
        ...
        getTitlePosition: function () {
            var a = this.horiz, b = this.left, c = this.top, d = this.len, e = this.options.title, f = a ? b : c,
                g = this.opposite, h = this.offset, i = e.x || 0, j = e.y || 0, k = D(e.style.fontSize || 12), d = {
                    low: f + (a ? 0 : d),
                    middle: f + d / 2,
                    high: f + (a ? d : 0)
                }[e.align],
