...
public final class BeanQueryFactory<Q extends AbstractBeanQuery> implements QueryFactory, Serializable {
    ...
    public Query constructQuery(final Object[] sortPropertyIds, final boolean[] sortStates) {
        ...
        try {
            query = queryClass.getConstructor(QueryDefinition.class, Map.class, Object[].class, boolean[].class)
                    .newInstance(queryDefinition, queryConfiguration, sortPropertyIds, sortStates);
        } catch (Exception e) {
