...
public class Axis {
    ...
    @Deprecated
    /**
     * Can cause an Exception if you forget to set an {@link AxisType}, use {@link #Axis(AxisType)} instead.
     */
    public Axis() {
    }
    ...
    /**
     * Returns the current {@link AxisType}.
     *
     * @return {@link AxisType}
     */
    ...
    /**
     * Set the {@link AxisType} for this instance.
    ...
    /**
     * Returns the current {@link AxisValueType} for this instance.
     * @return {@link AxisValueType}
     */
    ...
    /**
     * Set the {@link AxisValueType} for this instance.
    ...
    public String getHighChartValue() throws HighChartsException {
        ...
        //ticketInterval
//        builder.append(", tickInterval: " + ticketInterval);
