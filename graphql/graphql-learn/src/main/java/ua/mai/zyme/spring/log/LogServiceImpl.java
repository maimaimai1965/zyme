...
//                + " Params=" + requestMap
    ...
    @Override
    public void logResponse(HttpServletRequest request, String requestBody, HttpServletResponse response, String responsBody, long duration) {
        LOG.debug("[RESP_OUT] Status=" + response.getStatus() + " Duration=" + duration + "ms"
                + (responsBody != null  && responsBody.length() > 0 ? (" Body=" + responsBody) : ""));
    }
