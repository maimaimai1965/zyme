...
//    @ExceptionHandler(value = {Exception.class})
    @ExceptionHandler
    public Mono<ResponseEntity<Object>> handleAnyException(Exception ex) {
//        return new ResponseEntity<>(ex, HttpStatus.INTERNAL_SERVER_ERROR);
        return Mono.just(new ResponseEntity<>(ex, HttpStatus.INTERNAL_SERVER_ERROR));
    }

//    @ExceptionHandler
////    @ExceptionHandler(value = {ServiceFault.class})
//    public Mono<ResponseEntity<Object>> handleAnyException(ServiceFault ex) {
////        return new ResponseEntity<>(ex, HttpStatus.INTERNAL_SERVER_ERROR);
//        return Mono.just(new ResponseEntity<>(ex, HttpStatus.INTERNAL_SERVER_ERROR));
//    }

//    @ExceptionHandler
//    public ResponseEntity<Object> handleAnyException(ServiceFault ex) {
//        return new ResponseEntity<>(ex.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
//    }

//    @ExceptionHandler
//    public ResponseEntity<Object> handleAnyException(ServiceFault ex) {
//        return detailResponseBuild(HttpStatus.INTERNAL_SERVER_ERROR, ex.getCode(), ex.getMessage(), null);
//    }

    @ExceptionHandler({ServiceFault.class})
    public Mono<ResponseEntity<Object>> handleMyException(ServiceFault ex, ServerWebExchange exchange) {
        return //handleExceptionInternal(ex, null, ex.getMessage(), ex.getCode(), exchange);
                Mono.just(new ResponseEntity<>(ex.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR));
    }
...
//    @ExceptionHandler(value = {ServiceFault.class})
//    public Mono<ResponseEntity<Object>> handleAnyException(ServiceFault ex, WebRequest request) {
////        return new ResponseEntity<>(ex, HttpStatus.INTERNAL_SERVER_ERROR);
//        return Mono.just(new ResponseEntity<>(ex, HttpStatus.INTERNAL_SERVER_ERROR));
//    }
...
//    private ResponseEntity<Object> detailResponseBuild(
//                                                       /*ServletException ex,*/
//                                                       HttpStatus status,
