...
/**
 * <pre>
 * Security конфигурация для приложения <i><b>SecurityGwtBasicApplication</i></b>, реализующая алгоритм:
 *
 * a) Получение <i>GWT</i> токена для пользователя по <b>URL <i>"/login"</i></b>.
 ...
 *
 * b) Запрос с использованием полученного GWT токена:
 ...
 *
 * с) Запрос без использования GWT токена:
...
@Configuration
public class AuthServerWebSecurityConfigurerAdapter extends WebSecurityConfigurerAdapter {
