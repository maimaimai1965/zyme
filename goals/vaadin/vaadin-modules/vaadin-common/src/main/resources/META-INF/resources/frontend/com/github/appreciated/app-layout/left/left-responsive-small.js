...
class AppLayoutLeftResponsiveSmall extends ElementMixin(ThemableMixin(PolymerElement)) {
...
customElements.define(AppLayoutLeftResponsiveSmall.is, AppLayoutLeftResponsiveSmall);