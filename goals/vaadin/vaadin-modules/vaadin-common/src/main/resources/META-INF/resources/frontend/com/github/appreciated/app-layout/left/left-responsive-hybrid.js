...
class AppLayoutLeftResponsiveHybrid extends ElementMixin(ThemableMixin(PolymerElement)) {
...
customElements.define(AppLayoutLeftResponsiveHybrid.is, AppLayoutLeftResponsiveHybrid);