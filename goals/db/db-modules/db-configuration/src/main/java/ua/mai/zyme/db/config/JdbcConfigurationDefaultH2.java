...
/**
 * <pre>
 * Бины для доступа к БД H2 (для дефолтных спринговых настроек, которые задаются в spring.*).
 *
...
@EnableConfigurationProperties({
        JdbcConfigurationDefaultH2.HikariConfigDefault.class
})
public class JdbcConfigurationDefaultH2 {
