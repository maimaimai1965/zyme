package ua.mai.zyme.graphql.authentication;
...
//import ua.mai.zyme.rest.zoo.authentication.H2JdbcUserDetailsManager;
...
//import ua.mai.zyme.rest.zoo.controllers.AuthController;
//import ua.mai.zyme.rest.zoo.controllers.ZooController;
...
/**
 * <pre>
 * Security конфигурация для приложения <i><b>GraphqlZooApplication</i></b>, реализующая алгоритм:
 *
 * TODO изменить описание. Оно неправильное
 *
 ...
 *    3. Далее вызывается метод контроллера {@link ZooController}, соответствующего URL.
 ...
 *
 * Объявляются бины:
 * 1. <i>userDetailsService</i>: {@link H2JdbcUserDetailsManager}, который использует embedded H2 схему zyme03.
 *    Используются таблицы <i>USER, AUTHORITY</i>.
 *    Manager предоставляет авторизацию по ролям без использованием групп ролей.
 * 2. <i>passwordEncoder</i>: {@link NoOpPasswordEncoder} - пароли при хранении не кодируются;.
 *
 * </pre>
 */
@EnableWebSecurity
...
@Configuration
public class GraphqlZooWebSecurityConfigurerAdapter extends WebSecurityConfigurerAdapter {
